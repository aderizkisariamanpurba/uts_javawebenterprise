...
public class CategoryService{
    ...
    public Category updateCategory(Category category, Integer id) {
        ...
        if(updateCategory != null) {
            updateCategory.setKd_Sperpart(category.getKd_Sperpart());
            updateCategory.setNama_Sperpart(category.getNama_Sperpart());
            updateCategory.setJenis_Sperpart(category.getJenis_Sperpart());
        }
